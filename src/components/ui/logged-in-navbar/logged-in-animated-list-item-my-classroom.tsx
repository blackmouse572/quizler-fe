...
export const LoggedInAnimatedListItemMyClassroom = React.forwardRef<
  React.ElementRef<"a">,
  Omit<AnimatedProps, "children">
>(({ className, classname, id, icon = "School", ...props }, ref) => {
    ...
    <li>
      <NavigationMenuLink asChild>
        ...
        >
          ...
          <div className="text-sm font-[500] leading-none">{classname}</div>
        </Link>
      </NavigationMenuLink>
    </li>
  )
...
LoggedInAnimatedListItemMyClassroom.displayName = "LoggedInAnimatedListItemMyClassroom"
