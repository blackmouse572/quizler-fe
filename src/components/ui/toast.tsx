...
const toastVariants = cva(
  'group pointer-events-auto relative flex w-full items-center justify-between space-x-2 overflow-hidden rounded-md border p-4 pr-6 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full',
  {
    variants: {
      ...
      color: {
        primary: 'text-primary bg-primary-foreground default',
        accent: 'text-accent-foreground bg-accent accent',
        danger: 'text-danger-50 bg-danger-500 danger',
        success: 'text-success-50 bg-success-500 success',
        warning: 'text-warning-50 bg-warning-500 warning',
      },
    },
    defaultVariants: {
      variant: 'default',
...
>(({ className, variant, color, ...props }, ref) => {
  return <ToastPrimitives.Root ref={ref} className={cn(toastVariants({ variant, color }), className)} {...props} />;
});
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      'group-[.primary]:text-primary-foreground group-[.primary]:hover:text-primary-50 group-[.primary]:focus:ring-primary group-[.primary]:focus:ring-offset-primary-600',
      className
    )}
    toast-close=""
    {...props}
